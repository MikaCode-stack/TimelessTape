        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerReviews_Titles_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Titles_TitleId",
                        column: x => x.TitleId,
                        principalTable: "Titles",
                        principalColumn: "TitleId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LateFees_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerReviews_TitleId",
                table: "CustomerReviews",
                column: "TitleId");

            migrationBuilder.CreateIndex(
                name: "IX_LateFees_TransactionId",
                table: "LateFees",
